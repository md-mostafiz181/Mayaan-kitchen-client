...
//       {title && (<Cover  img={coverImg}  title={title} subTitle="would you like to try dish?" ></Cover> )}
...
//                 <button class="addBtn uppercase ">
//                 <span className="font-bold">Ordered Your Favorite Food</span>
//                 </button>
//             </div>
//         </Link>
//     </div>
